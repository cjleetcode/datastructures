...
binary_heap::binary_heap(vector<binary_node*> vec) : heap_size(vec.size()) {
    heap = vec;
...
void binary_heap::insert(binary_node* b) {
...
binary_node* binary_heap::deleteMin() {
...
binary_node* binary_heap::findMin() {
    if (heap_size == 0) {
